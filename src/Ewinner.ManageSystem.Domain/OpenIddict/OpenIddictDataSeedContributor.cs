...
namespace Ewinner.ManageSystem.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
	...
	{
		if (await _openIddictScopeRepository.FindByNameAsync("ManageSystem") == null)
		{
			await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
			{
				Name = "ManageSystem",
				DisplayName = "ManageSystem API",
				Resources = { "ManageSystem" }
			});
		}
	}
	...
	private async Task CreateApplicationsAsync()
	{
		...
		//Web Client
		var webClientId = configurationSection["ManageSystem_Web:ClientId"];
		if (!webClientId.IsNullOrWhiteSpace())
		{
			var webClientRootUrl = configurationSection["ManageSystem_Web:RootUrl"]!.EnsureEndsWith('/');

			/* ManageSystem_Web client is only needed if you created a tiered
			...
			await CreateApplicationAsync(
				...
				secret: configurationSection["ManageSystem_Web:ClientSecret"] ?? "1q2w3e*",
		...
		// Swagger Client
		var swaggerClientId = configurationSection["ManageSystem_Swagger:ClientId"];
		if (!swaggerClientId.IsNullOrWhiteSpace())
		{
			var swaggerRootUrl = configurationSection["ManageSystem_Swagger:RootUrl"]?.TrimEnd('/');
