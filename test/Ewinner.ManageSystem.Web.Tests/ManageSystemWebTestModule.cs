...
using Ewinner.ManageSystem.Web;
...
[DependsOn(
	...
	typeof(ManageSystemWebModule),
	typeof(ManageSystemApplicationTestModule),
	typeof(ManageSystemEntityFrameworkCoreTestModule)
)]
public class ManageSystemWebTestModule : AbpModule
{
	public override void PreConfigureServices(ServiceConfigurationContext context)
	{
		context.Services.PreConfigure<IMvcBuilder>(builder =>
		{
			builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(ManageSystemWebModule).Assembly));
		});
